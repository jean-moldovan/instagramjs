...
function buildRequestMethod(method, url, request) {
  return function (params, fullResponse, timeout) {
    ...
    return request(removeEmpty({ method: method, url: url, timeout: timeout, fullResponse: fullResponse, params: params }));
  };
}
...
module.exports = {
  ...
  buildConnectionError: buildConnectionError,
  buildRequestMethod: buildRequestMethod,
  buildSearchMethod: buildSearchMethod,
  assign: assign
};